...
type FakeCAPIClient struct {
	...
	GetOrgRoleAssignmentsStub        func(logger lager.Logger, orgGUID string) ([]migrator.RoleAssignment, error)
	...
	getOrgRoleAssignmentsReturns struct {
		result1 []migrator.RoleAssignment
		result2 error
	}
	...
	GetSpaceRoleAssignmentsStub        func(logger lager.Logger, spaceGUID string) ([]migrator.RoleAssignment, error)
...
func (fake *FakeCAPIClient) GetOrgRoleAssignments(logger lager.Logger, orgGUID string) ([]migrator.RoleAssignment, error) {
...
func (fake *FakeCAPIClient) GetOrgRoleAssignmentsReturns(result1 []migrator.RoleAssignment, result2 error) {
...
func (fake *FakeCAPIClient) GetOrgRoleAssignmentsReturnsOnCall(i int, result1 []migrator.RoleAssignment, result2 error) {
	fake.GetOrgRoleAssignmentsStub = nil
...
func (fake *FakeCAPIClient) GetSpaceRoleAssignments(logger lager.Logger, spaceGUID string) ([]migrator.RoleAssignment, error) {
...
func (fake *FakeCAPIClient) GetSpaceRoleAssignmentsReturns(result1 []migrator.RoleAssignment, result2 error) {
...
func (fake *FakeCAPIClient) GetSpaceRoleAssignmentsReturnsOnCall(i int, result1 []migrator.RoleAssignment, result2 error) {
	fake.GetSpaceRoleAssignmentsStub = nil
...
var _ migrator.CAPIClient = new(FakeCAPIClient)
